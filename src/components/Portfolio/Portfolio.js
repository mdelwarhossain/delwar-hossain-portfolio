...
const Portfolio = () => {
    return (
        <div className='min-h-screen my-10'>
            ...
            <h2 className='text-2xl font-bold text-center'>Here is my last 3 projects</h2>
            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                ...
                <div className="card-body items-center text-center">
                    ...
                    <a className='text-green-600' href="https://resale-books-a74e3.web.app/">Browse Website</a>
            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                ...
                <div className="card-body items-center text-center">
                    ...
                    <a className='text-green-600' href="https://photography-assignment-b3b07.web.app/">Browse Website</a>
                    <div className="card-actions">
                        <button className="btn btn-accent">See Details</button>
                    </div>
                </div>
            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                ...
                <div className="card-body items-center text-center">
                    ...
                    <a className='text-green-600' href="https://learning-platform-client-41d2f.web.app/">Browse Website</a>
                    <div className="card-actions">
                        <button className="btn btn-accent">See Details</button>
                    </div>
                </div>
